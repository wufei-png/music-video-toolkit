...
Checked through 2026-09-21. Research report remains in the parent production workspace; its recommendations are background, not an executable API contract. This document makes the repository self-contained without redistributing that report.
